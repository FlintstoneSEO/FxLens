      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_1.15fr]">
        ...
        <SectionCard title={panelMeta.rightTitle} description={panelMeta.rightDescription}>
          ...
          {!response && !error ? (
            <StatusMessage
              tone="info"
              message="Generate build output to see screen, component, and formula recommendations."
            />
          ) : null}
          ...
          {response ? (
            <div className="space-y-4">
              ...
              <section className="space-y-3">
                <h3 className="text-sm font-semibold tracking-tight">Suggested Screens</h3>
